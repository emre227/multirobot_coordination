...
# Aus einer Liste mit den Abständen wird der niedrigste Index ermittelt, der zugehörige TurtleBot
# bekommt dann die Koordinaten und bewegt sich daraufhin zum Ziel.
...
if __name__ == '__main__':
    ...
    # Beispiel für einen fünften TBot:
    ...
    while not rospy.is_shutdown():                 
        ...
        #Liste der translatorischen Koordinaten: wenn mehr TBots, dementsprechend Elemente zur Liste hinzufügen
        ...
        # Index = 0 -> TBot1, Index = 1 -> TBot2, Index = 2 -> TBot3 usw.
